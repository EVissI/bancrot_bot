...
async def process_referal(message: Message, state: FSMContext):
    ...
    text = f"""🌟<b>✨ Благодарим за вашу рекомендацию!</b><br>
Мы свяжемся с <b>{recommended_fio}</b> по номеру <b>{recommended_phone}</b> в ближайшее время.<br><br>

🔥 <b>Но почему бы не пойти дальше?</b><br>
Чем больше друзей вы приведете, тем выше будет ваша персональная премия:<br><br>

• 5 друзей = <b>75 000₽</b><br>
• 10 друзей = <b>200 000₽</b><br><br>

👉 <b>Продолжайте рекомендовать и экономьте:</b><br>"""
    msg = await message.answer(
